...
import { DataTable } from '@/app/(root)/admin/flight_schedule/departure/table/data-table'; // Adjust the import based on your actual DataTable component path
import getDepartureManualFlightSchedule from '@/app/hook/departure_flight_schedule/departure_flight_schedule';
import { columns } from '@/app/(root)/admin/flight_schedule/departure/table/columns'; // Assuming you have a columns definition for the table
...
export default function DepartureFlightSchedule() {
