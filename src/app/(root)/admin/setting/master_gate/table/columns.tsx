...
import { DeleteGateMaster } from './delete-item-category-master';
...
import {EditGateMaster} from '@/app/(root)/admin/setting/master_gate/table/edit-item-category-master'
    ...
    }, 
    {
        ...
        return (
            <DropdownMenu>
                ...
                <EditGateMaster stockMaster={rowData} isOpen={isSheetOpen} onOpenChange={setSheetOpen} />
                <DeleteGateMaster id={rowData.id} isOpen={isDialogOpen} onOpenChange={setDialogOpen}/>
            </DropdownMenu>
            )
        },
    },
