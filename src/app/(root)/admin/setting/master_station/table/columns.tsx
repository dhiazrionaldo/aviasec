...
import { DeleteStationMaster } from './delete-item-category-master';
...
import {EditStationMaster} from '@/app/(root)/admin/setting/master_station/table/edit-item-category-master'
...
export const columns: ColumnDef<stations>[] = [
    {
    ...
    }, 
    {
        ...
        return (
            <DropdownMenu>
                ...
                <EditStationMaster stockMaster={rowData} isOpen={isSheetOpen} onOpenChange={setSheetOpen} />
                <DeleteStationMaster id={rowData.id} isOpen={isDialogOpen} onOpenChange={setDialogOpen}/>
            </DropdownMenu>
            )
        },
    },
