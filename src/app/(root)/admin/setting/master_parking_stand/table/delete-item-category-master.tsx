...
import { deleteParkingStand } from "@/app/hook/setting/parking_stand";
...
export function DeleteParkingStandMaster({id, isOpen, onOpenChange}: Props){
    ...
    const queryClient = useQueryClient();
     ...
     async function deleteSKU(){
        setLoading(true)
        try {
            const res = await deleteParkingStand(id);
