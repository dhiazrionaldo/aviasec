...
import { DeleteParkingStandMaster } from './delete-item-category-master';
...
import {EditParkingStandMaster} from '@/app/(root)/admin/setting/master_parking_stand/table/edit-item-category-master'
    ...
    }, 
    {
        ...
        return (
            <DropdownMenu>
                ...
                <EditParkingStandMaster stockMaster={rowData} isOpen={isSheetOpen} onOpenChange={setSheetOpen} />
                <DeleteParkingStandMaster id={rowData.id} isOpen={isDialogOpen} onOpenChange={setDialogOpen}/>
            </DropdownMenu>
            )
        },
    },
