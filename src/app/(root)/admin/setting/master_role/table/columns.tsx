...
import { DeleteRoleMaster } from './delete-item-category-master';
...
import {EditRoleMaster} from '@/app/(root)/admin/setting/master_role/table/edit-item-category-master'
    ...
    }, 
    {
        ...
        return (
            <DropdownMenu>
                ...
                <EditRoleMaster stockMaster={rowData} isOpen={isSheetOpen} onOpenChange={setSheetOpen} />
                <DeleteRoleMaster id={rowData.id} isOpen={isDialogOpen} onOpenChange={setDialogOpen}/>
            </DropdownMenu>
            )
        },
    },
