...
import { DeleteCompanyMaster } from './delete-item-category-master';
...
import {EditCompanyMaster} from '@/app/(root)/admin/setting/master_company/table/edit-item-category-master'
    ...
    }, 
    {
        ...
        return (
            <DropdownMenu>
                ...
                <EditCompanyMaster stockMaster={rowData} isOpen={isSheetOpen} onOpenChange={setSheetOpen} />
                <DeleteCompanyMaster id={rowData.id} isOpen={isDialogOpen} onOpenChange={setDialogOpen}/>
            </DropdownMenu>
            )
        },
    },
